...
mixin _$OrderController on OrderControllerBase, Store {
  ...
  late final _$cangeStatusAsyncAction =
      AsyncAction('OrderControllerBase.cangeStatus', context: context);

  @override
  Future<void> cangeStatus(OrderStatus status) {
    return _$cangeStatusAsyncAction.run(() => super.cangeStatus(status));
  }
