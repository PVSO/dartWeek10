...
class _ProductDetailPageState extends State<ProductDetailPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      controller.loadProduct(widget.producId);
    });
  }
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Text(
                      '${widget.producId != null ? 'ALTERAR' : 'ADICIONAR'} PRODUTO',
                      ...
                      Container(
                        ...
                        child: TextButton(
                          ...
                          child: Observer(
                            builder: (_) {
                              return Text(
                                '${controller.imagePath == null ? 'Adicionar' : 'Alterar'} Imagem',
                              );
                            },
                          ),
                        ),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            if (valid) {
                              if (controller.imagePath == null) {
                                showWarning(
                                  'Imagem é obrigatória!! Clique em Adicionar Imagem',
                                );
                                return;
                              }
                              controller.save(
